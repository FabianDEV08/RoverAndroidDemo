...
class DemoAppRoomDatabaseTest {
    ...
    companion object {
        ...
        fun populateDatabase(ownerDao: OwnerDao, dogDao: DogDao) = runBlocking {
            ...
            ownerDao.insert(owner)
            var dog = Dog(1, "Max", "Doberman", 4, "male", "photo_path.jpg", 1)
            dogDao.insert(dog)
            dog = Dog(2, "Nahala", "French Poodle", 3, "female", "photo_path.jpg", 3)
            dogDao.insert(dog)
            dog = Dog(3, "Hulk", "Pit Bull", 5, "male", "photo_path.jpg", 1)
            dogDao.insert(dog)
            dog = Dog(4, "Crazy Legs", "Greyhound", 2, "male", "photo_path.jpg", 2)
            dogDao.insert(dog)
            dog = Dog(5, "Manchas", "Jack Russell", 7, "male", "photo_path.jpg", 1)
            dogDao.insert(dog)
        }
    }
}